...
# grams
lmer_grams_office_V3 <- lmer(grams ~ preFF + avg_vas + meal_order + ps_prop*V3 + (1 | id), data = list_of_clean_dataframes[[4]])
anova(lmer_grams_office_V3)

lmer_grams_office_V4 <- lmer(grams ~ preFF + avg_vas + meal_order + ps_prop*V4 + (1 | id), data = list_of_clean_dataframes[[4]])
anova(lmer_grams_office_V4)

lmer_grams_food_V3 <- lmer(grams ~ preFF + avg_vas + meal_order + ps_prop*V3 + (1 | id), data = list_of_clean_dataframes[[5]])
anova(lmer_grams_food_V3)

lmer_grams_food_V4 <- lmer(grams ~ preFF + avg_vas + meal_order + ps_prop*V4 + (1 | id), data = list_of_clean_dataframes[[5]])
anova(lmer_grams_food_V4)
